        ...
        cards=[
          {
            ...
            action: Some((
              ...
              <Lang.String
                english="Get the VSCode extension" french={`Obtenir l'extension VSCode`}
              />,
            )),
            content: <p>
              <Lang.String
          ...
          },
          {
            ...
            content: <p>
              <Lang.String
                ...
                of your old rules engine, and hence carry on an incremental migration
                without outages."
          ...
          },
          {
            ...
            content: <p>
              <Lang.String
                ...
                No single company has the exclusive rights to maintaining it, and the "
              ...
              />
              <Lang.String
                english=" organizes an ecosystem of qualified companies that can provide such maintenance services.
                Ultimately, in the worst case,
                you can directly maintain and update the code generated by the compiler without relying on the Catala toolchain."
                french={` organise un écosystème d'entreprises de services numériques compétentes sur le logiciel. Et au pire,
                vous pouvez maintenir et mettre à jour le code généré par compilateur sans dépendre de l'outillage Catala.`}
              />
            </p>,
          },
          {
            ...
            content: <p>
              <Lang.String
                ...
                all the edge cases and arcane rules of a national system of taxes and social benefits
              ...
              cas tordus et règles obscures, un système national de calculs d'impôts ou de prestation
              sociales dans un pays développé.`}
              />
            </p>,
          },
        ]
        ...
        cards=[
          {
            ...
            content: <>
              ...
              simulator to quickly estimate the eligibility and amount
 ...
 d'un simulateur Web.`}
          ...
          },
          {
            ...
            standard mondial de représentation XML des objets juridiques.`}
              ...
              <Lang.String
                english="But you should use Catala if you simply want to program
