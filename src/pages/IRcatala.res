let pageTitle =
  <Lang.String english="French Income Tax" french={`Code de l'impôt sur le revenu`} />
...
let card: Card.Presentation.t = {
  ...
  content: <>
    ...
    <Link.Text target="https://gitlab.adullact.net/dgfip/ir-catala">
      <Lang.String english="DGFiP's public Gitlab." french={`le Gitlab public de la DGFiP`} />
    </Link.Text>
    <Lang.String
...
external fetch_unzip_and_show_pdf: (~url: string, ~filename: string, ~id: string) => unit =
