...
[@react.component]
let make = () => {
  <footer className=[%tw "bg-primary text-center border-t-8 border-secondary pt-4"]>
    <div className=[%tw "text-white pb-4"]> {React.string("Copyright 2020 Inria")} </div>
    <div className=[%tw "bg-yellow-500"]>
      <span>
